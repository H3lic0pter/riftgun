...
final class PortalModuleRulesTest {
    ...
    void aggregatesCapacityAndSurfaceRange() {
        PortalModuleRules rules = new PortalModuleRules(8000, 8000, 2, 32, 16, 3, 2, 45, 15, false);
        ...
        assertFalse(PortalModuleRules.load(rules.save()).matterAnchorPreventsDespawn());
    }

    @Test
    void sanitizesInvalidServerValuesAndSaturatesOverflow() {
        PortalModuleRules rules = new PortalModuleRules(0, 0, -1, 0, 0, -1, -1, 0, 0, true);
        ...
        PortalModuleRules huge = new PortalModuleRules(Integer.MAX_VALUE, Integer.MAX_VALUE, 9,
            Integer.MAX_VALUE, Integer.MAX_VALUE, 9, 9, Integer.MAX_VALUE, Integer.MAX_VALUE, true);
