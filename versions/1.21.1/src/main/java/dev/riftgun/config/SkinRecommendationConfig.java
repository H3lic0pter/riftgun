...
public final class SkinRecommendationConfig {
    ...
    public SkinRecommendationConfig(ModConfigSpec.Builder builder) {
        ...
        presets = Map.of(
            ...
            "riftgun:arcane_rift_staff", new Preset(builder, "arcane_rift_staff", "riftgun:arcane", "riftgun:arcane", "riftgun:arcane", "riftgun:magic_circle", "SWING"),
            "riftgun:pink_water_gun", new Preset(builder, "pink_water_gun", CUSTOM, CUSTOM, CUSTOM, CUSTOM, CUSTOM));
        builder.pop(2);
    }
