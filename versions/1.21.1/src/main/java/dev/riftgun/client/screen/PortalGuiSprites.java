...
final class PortalGuiSprites {
    ...
    static final ResourceLocation PLACEMENT_REMOTE = icon("placement_remote");
    ...
    static final ResourceLocation DIMENSIONAL_TRAVERSAL = icon("dimensional_traversal");
    static final ResourceLocation RANDOM_RIFT_ON = icon("random_rift_on");
    static final ResourceLocation RANDOM_RIFT_OFF = icon("random_rift_off");
    ...
    static final ResourceLocation SURFACE_SIZE_FULL_SUPPORT = icon("surface_size_full_support");
    static final ResourceLocation SURFACE_SIZE_ADAPTIVE = icon("surface_size_adaptive");
    static final ResourceLocation SURFACE_SIZE_PREFER_LARGE = icon("surface_size_prefer_large");
    static final ResourceLocation COLOR = icon("color");
    ...
    static ResourceLocation recommendation(dev.riftgun.config.SkinRecommendationConfig.Category category, boolean enabled) {
    ...
    static void drawCentered(GuiGraphics graphics, ResourceLocation sprite,
