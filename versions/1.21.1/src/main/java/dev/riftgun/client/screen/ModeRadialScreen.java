...
public final class ModeRadialScreen extends Screen {
    ...
    public void refreshFromServer() {
        ...
        remoteDistance = Math.clamp(PortalClientState.gun().getInt("RemoteDistance"),
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        switch (ModeRadialPointerAction.resolve(button, precisionPreviewOnly,
            overRangeSlider(mouseX, mouseY), page == Page.SURFACE_FACE,
