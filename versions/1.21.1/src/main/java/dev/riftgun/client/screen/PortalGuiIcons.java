...
final class PortalGuiIcons {
    ...
    static void drawColorIcon(GuiGraphics graphics, int x, int y, int width, int height) {
    ...
    static void drawFunctionModeIcon(GuiGraphics graphics, int buttonX, int buttonY,
